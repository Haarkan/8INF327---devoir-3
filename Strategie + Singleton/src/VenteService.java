...
public class VenteService {
	...
	public List<Vente> filtrerParStrategie () {
		...
		// On réccupère le where de la requête
		String queryWhere = strategieCourante.Filtrer();

		// On execute la requete et on renvoie le résultat, ici impossible car pas de DB 
		System.out.println("Requête avec filtre: " + queryWhere);
